...
initial_model="Qwen/Qwen2.5-Math-1.5B" # "/shared/storage-01/jiarui14/EM-CoT/verl/checkpoints/verl-math-new/Qwen2.5-Math-1.5B-raft-vanilla-numina_math_flat_em_stage1n64-sample64-iter1/global_step_250/actor/huggingface"
